\renewcommand{\appendixpagename}{\vspace*{\fill}\centering \textit{Web Appendix:} Emulating target trials of postexposure vaccines using observational data\vspace*{\fill} } % Appendices title
